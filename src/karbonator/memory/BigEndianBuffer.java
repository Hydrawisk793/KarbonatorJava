...
class BigEndianBuffer implements Buffer {
    @Override
    public int getSize() {
    ...
    public short readInt16() {
        short result = (short)((readInt8()&0xFF)<<8);
        result |= (short)(readInt8()&0xFF);
    ...
    public int readInt32() {
        int result = (int)((readInt8()&0xFF)<<24);
        result |= ((readInt8()&0xFF)<<16);
        result |= ((readInt8()&0xFF)<<8);
        result |= (readInt8()&0xFF);
    ...
    public BigEndianBuffer() {
        buffer = new Vector<Byte>();
    }
    
    public BigEndianBuffer(BigEndianBuffer o) {
        this();
    ...
    public BigEndianBuffer(byte [] bytes) {
        this();
    ...
    public BigEndianBuffer(Array<Byte> bytes) {
        this();
